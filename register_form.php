         ...
         if($passwords != $cpasswords){
            ...
            if (filter_var($email, FILTER_VALIDATE_EMAIL)) {
               ...
               if (endsWith($email, "@gmail.com")) {
                  ...
                  $code = rand(0000,9999);
                  $info = [$userName, $email, $code, $passwords];   
                  $_SESSION['register'] = $info; 
                  header('Location: email/confirm_User.php');
                  exit();
                } else {
